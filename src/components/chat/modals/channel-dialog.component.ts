  ...
  template: `
    <hlm-dialog>
      ...
      <button hlmDialogTrigger
        ...
        <ng-icon name="lucideTv" class="text-xl text-zinc-400 dark:text-zinc-500 shrink-0"></ng-icon>
      ...
      <hlm-dialog-content *hlmDialogPortal="let ctx" 
        ...
        <div class="p-5 space-y-6 max-h-[75vh] overflow-y-auto custom-scrollbar">
          ...
          <div class="space-y-3 pt-1 border-t border-zinc-200 dark:border-zinc-800">
            <span class="block text-xs font-semibold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">Channel Type</span>
            ...
            <label 
              ...
              [class.bg-zinc-100]="channelType() === 'private'"
              [class.dark:bg-zinc-800/60]="channelType() === 'private'">
              <div class="space-y-1 text-left">
                <span class="block text-sm font-medium text-zinc-900 dark:text-zinc-100">Private Channel</span>
            ...
            <label 
              ...
              class="flex items-start justify-between gap-3 p-3 rounded-xl border border-transparent hover:bg-zinc-100/70 dark:hover:bg-zinc-800/50 cursor-pointer transition-colors"
              [class.bg-zinc-100]="channelType() === 'public'"
              [class.dark:bg-zinc-800/60]="channelType() === 'public'">
              <div class="space-y-1 text-left">
                <span class="block text-sm font-medium text-zinc-900 dark:text-zinc-100">Public Channel</span>
                <p class="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
